package CaseStudies; /**
 ...
 Note the digits of a two-digit number may be 0. If a number is less than 10, we assume that the number is preceded by
 a 0 to form a two-digit number. For example, number 8 is treated as 08, and number 0 is treated as 00 in the program.
...
public class CaseStudy3_12 {
    public static void main(String[] args) {
        ...
        System.out.print("Enter in your lottery pick two digits): ");
